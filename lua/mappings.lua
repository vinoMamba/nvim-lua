...
map("n", "<C-b>", "<Nop>")
map("n", "<C-e>", "<Nop>")
map("n", "<C-s>", "<Nop>", { desc = "file save" })
map("n", "<C-c>", "<Nop>", { desc = "file copy whole" })
map("n", "<leader>b", "<Nop>", { desc = "buffer new" })
map("n", "<leader>/", "<Nop>", { desc = "comment toggle" })
map("n", "<C-n>", "<Nop>", { desc = "nvimtree toggle window" })
map("n", "<leader>e", "<Nop>", { desc = "nvimtree focus window" })
...
-- nvimtree
map("n", "<A-2>", "<cmd>NvimTreeToggle<CR>", { desc = "Toggle file explore" })
